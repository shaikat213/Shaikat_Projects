...
$(document).ready(function () {
    ...
    function SalesLeadList() {
        ...
        self.getOfficeDesgArea = function () {
            ...
            $.ajax({
                type: "GET",
                url: '/IPDC/Designation/GetDesignationProductMapping?id=' + setng,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    self.SngArea(data);
        ...
        self.removeDetail = function (receiveDetail) {
            ...
            $.getJSON("/IPDC/Designation/RemoveDesignationProductMap/?id=" + receiveDetail.Id, null, function (data) {
        ...
        self.addData = function () {
            ...
            $.ajax({
                type: "POST",
                url: '/IPDC/Designation/SaveDesignationProductMapping',
                data: ko.toJSON(quesDetails),
                contentType: "application/json",
                success: function (data) {
                    $('#successModal').modal('show');
