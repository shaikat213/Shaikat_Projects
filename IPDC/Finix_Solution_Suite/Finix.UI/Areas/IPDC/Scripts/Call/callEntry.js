...
$(document).ready(function () {
    ...
    var CallEntryViewModel = function () {
        ...
        self.AgeRange = ko.observable().extend({
            required: {
                message: 'Please give Age information', onlyIf: function () {
                    return self.IsOrganization() === "false";
                }
            }
        });
        ...
        self.CustomerAddress.DivisionId.extend({
            required: {
                ...
                onlyIf: function () {
                    return ((self.CallType() === 3) || (self.CallStatus() === 2));
                }
            }
        });
        ...
        self.CustomerAddress.Email.extend({
            email: true
        });
        ...
        self.addressErrors = ko.validation.group(self.CustomerAddress);
        self.IsValid = ko.computed(function () {
            //debugger;
            //console.log("errors " + self.errors().length);
            //console.log("errors2 " + self.addressErrors().length);
