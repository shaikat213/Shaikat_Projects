...
$(document).ready(function () {
    ...
    var DeveloperEntryViewModel = function () {
        ...
        self.YearOfEstablishment = ko.observable().extend({ digit: true, minLength: 4 });;
        ...
        self.ContactPersonPhone = ko.observable().extend({
            digit: true,
            minLength: 11,
        ...
        self.AcademicQualificationList = ko.observableArray([]);
        ...
        self.GetAcademicQualificationList = function () {
            return $.ajax({
                type: "GET",
                ...
                success: function (data) {
                    self.AcademicQualificationList(data); //Put the response in ObservableArray
                },
            ...
            return $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.Directors.length > 0) {
                        $.when(self.GetAcademicQualificationList()).done(function() {
        ...
        self.Initializer = function () {
            if (self.Id() > 0) {
                ...
                self.GetAcademicQualificationList(),
