$(document).ready(function () {
    function OpLoanApplicationVm() {
        ...
        self.GotoDclExceptions = function (data) {
            var parameters = [{
                Name: 'Id',
                Value: data.DclId
            },
            ...
            var menuInfo = {
                Id: 142,
                Menu: 'Operation Exceptions',
                Url: '/IPDC/Operations/DCLExceptions',
    ...
    ko.applyBindings(opLAvm, document.getElementById("dclException"));
});