...
$(document).ready(function () {
    var HomeLoanViewModel = function () {
        var self = this;
        ...
        self.MaxConsiderIncomePercentRounded = ko.pureComputed(function () {
            ...
            $.each(dbrIncomeRange, function (index, value) {
                if (value.LoanType === 1 && totalMonthlyIncome >= value.MinIncome && totalMonthlyIncome <= value.MaxIncome) {
    ...
    var alVm = new HomeLoanViewModel();
    ko.applyBindings(alVm, document.getElementById("homeLoan")[0]);
});